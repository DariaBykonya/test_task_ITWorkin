...
const dataSlice = createSlice({
  ...
  reducers: {
    loadMockData: (state, action: PayloadAction<Character[]>) => {
...
export const { loadMockData } = dataSlice.actions;
